...
public class SHZS_zhenxian3 extends Fragment {
    ...
    private void loaDAta() {
        ...
        mSssi.setText("过去一分钟最大相对浓度:" + max );
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.shzs_zhexian2, container, false);
        return view;
    }
        ...
        new Http().sendResUtil("get_all_sense", jsonObject.toString(), "POST", new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                try {
                    ...
                    temperature = jsonObject1.getString("co2");
    ...
    private void initView() {
        mSssi = (TextView) getView().findViewById(R.id.sssi1);
        mZhenxiantu = (LineChart) getView().findViewById(R.id.zhenxiantu1);
    }
}
